...
CREATE TABLE `merchant_rooms` (
  ...
  `is_forced_off_sale` tinyint unsigned NOT NULL DEFAULT '0' COMMENT '平台强制禁售：0否 1是',
  `feature_tags` json DEFAULT NULL COMMENT '房间特性标签',
  `device_remark` varchar(50) NOT NULL DEFAULT '' COMMENT '设备备注',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`),
...
CREATE TABLE `merchant_stay_orders` (
  `id` int unsigned NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `merchant_user_id` int unsigned NOT NULL COMMENT '商家用户ID',
...
CREATE TABLE `merchant_stay_guests` (
  `id` int unsigned NOT NULL AUTO_INCREMENT COMMENT '主键ID',
...
CREATE TABLE `merchant_stay_extensions` (
  `id` int unsigned NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `stay_order_id` int unsigned NOT NULL COMMENT '入住订单ID',
  `merchant_user_id` int unsigned NOT NULL COMMENT '商家用户ID',
